                ...
                <div class="row ">
                    <div class="col-xl-8 col-md-4 col-sm-4 col-auto my-md-0 mt-5 order-sm-1 order-3 align-self-end">
                        <p class="social text-muted mb-0 pb-0 bold-text">
                            <span class="mx-2"><i class="fab fa-facebook-f" aria-hidden="true"></i></span>
                            ...
                            <span class="mx-2"><i class="fab fa-instagram" aria-hidden="true"></i></span></p>
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-4 col-auto order-1 align-self-end ">
                        ...
                        <span><i class="fa fa-envelope" aria-hidden="true"></i></span> anirudh@gmail.com</small>
                    </div>
