                ...
                <div class="col">
                    <Card class="mb-3 shadow-sm">
                        ...
                        <CardBody>
                            ...
                            <p class="card-text">
                                <small class="text-muted">Creado: {moment(article.created_at).format('LLLL')}</small>
                                <br />
                                <small class="text-muted">actualizado: {moment(article.updated_at).format('LLLL')}</small>
                            </p>
                            <a rel="prefetch" href="blog/{article.url}" class="btn btn-primary">ver más</a>
                        </CardBody>
                    </Card>
                </div>
            {:else}
